...
$tokens = @{
    ...
    ShieldVersion         = ConvertTo-ShieldsBadgeValue -Value $metadata.Version
    AssemblyVersion       = $metadata.AssemblyVersion
    ShieldAssemblyVersion = ConvertTo-ShieldsBadgeValue -Value $metadata.AssemblyVersion
    ...
    ShieldTargetFramework = ConvertTo-ShieldsBadgeValue -Value $metadata.TargetFramework
